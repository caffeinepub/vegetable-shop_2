...
import type { ExternalBlob as _ExternalBlob, UserProfile as _UserProfile, UserRole as _UserRole, Vegetable as _Vegetable, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createVegetable(arg0: string, arg1: number, arg2: string, arg3: string, arg4: boolean, arg5: ExternalBlob | null): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.createVegetable(arg0, arg1, arg2, arg3, arg4, await to_candid_opt_n10(this._uploadFile, this._downloadFile, arg5));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteVegetable(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteVegetable(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllVegetables(): Promise<Array<Vegetable>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllVegetables();
    ...
    async getVegetable(arg0: bigint): Promise<Vegetable> {
        if (this.processError) {
            try {
                const result = await this.actor.getVegetable(arg0);
                return from_candid_Vegetable_n13(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getVegetablesByCategory(arg0: string): Promise<Array<Vegetable>> {
        if (this.processError) {
            try {
                const result = await this.actor.getVegetablesByCategory(arg0);
                return from_candid_vec_n12(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateVegetable(arg0: bigint, arg1: string, arg2: number, arg3: string, arg4: string, arg5: boolean, arg6: ExternalBlob | null): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateVegetable(arg0, arg1, arg2, arg3, arg4, arg5, await to_candid_opt_n10(this._uploadFile, this._downloadFile, arg6));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_Vegetable_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Vegetable): Promise<Vegetable> {
...
async function from_candid_vec_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Vegetable>): Promise<Array<Vegetable>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Vegetable_n13(_uploadFile, _downloadFile, x)));
}
